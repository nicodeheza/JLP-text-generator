  ...
  const loadPdf = useCallback(
    (file: File) => {
      ...
      pdf
        ...
        .catch((err: unknown) => {
          const error = err instanceof Error ? err : new Error('Failed to load PDF document')
...
export function useLoadPage({ pageNumber, canvasRef }: UseLoadPageParams): UseLoadPageReturn {
