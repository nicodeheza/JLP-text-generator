...
export const PdfBar: FC<Props> = ({
  ...
  return (
    <div className={styles.bar}>
      ...
      <Button variant="secondary" disabled={!file || !ocrReady || ocrLoading} onClick={onOcr}>
...
const Pages: FC<PagesProps> = ({ inputValue, totalPages, onPrev, onNext, onPageInputChange }) => {
  return (
    <div className={styles.pageSelect}>
      ...
      <Button variant="transparent" disabled={!totalPages} onClick={onNext} aria-label="next page">
